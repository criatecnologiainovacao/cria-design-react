...
export class Bar extends Component {
    ...
    clickTrackHandler(e) {
        ...
        const thumbPositionPercentage = ((offset - thumbHalf) * 100 /
                                         this.rootRef[this.bar.offset]);

        this.wrap[this.bar.scroll] = (thumbPositionPercentage * this.wrap[this.bar.scrollSize] /
                                      100);
    }
    ...
    mouseMoveDocumentHandler(e) {
        ...
        const offset = (e[this.bar.client] -
    ...
    render() {
        ...
        return (
            <div
                ...
                className={this.classNames('cd-scrollbar__bar', `is-${this.bar.key}`)}
                onMouseDown={this.clickTrackHandler}>
                <div
                    ref={thumb => this.thumbRef = thumb}
                    className="cd-scrollbar__thumb"
