...
export class Scrollbar extends Component {
  ...
  render() {
    ...
    const view = React.createElement(viewComponent, {
      className: this.classNames('cd-scrollbar__view', viewClass),
      style: viewStyle,
      ref: 'resize'
    }, children);
    ...
    if (!native){
      const wrap = (
        <div
          ...
          className={this.classNames(wrapClass, 'cd-scrollbar__wrap', gutter ? '' : 'cd-scrollbar__wrap--hidden-default')}
          >
          {view}
        </div>
      )
      ...
      nodes = [
        (
          <div
            ...
            key={0}
            ref="wrap"
            className={this.classNames(wrapClass, 'cd-scrollbar__wrap')}
            style={style}>
            {view}
          </div>
        )
    ...
    return React.createElement('div', {className: this.classNames('cd-scrollbar', className)}, nodes)
  }
}
