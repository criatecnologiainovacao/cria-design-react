...
class Select extends Component {
  ...
  onVisibleChange(visible: boolean) {
    ...
    if (!visible) {
      ...
      if (this.refs.root.querySelector('.cd-input__icon')) {
        const elements = this.refs.root.querySelector('.cd-input__icon');
      ...
      if (icon && !icon.classList.contains('cd-icon-circle-close')) {
        const elements = this.refs.root.querySelector('.cd-input__icon');
  ...
  onSelectedChange(val: any, bubble: boolean = true) {
    ...
    if (multiple) {
      ...
      if (bubble) {
        this.onChange(val.props.value, val);
        form && form.onFieldChange();
      }
    }
  }
  ...
  render() {
    ...
    return (
      <div ref="root" style={this.style()} className={this.className('cd-select')}>
        ...
        />
        <Transition name="cd-zoom-in-top" onEnter={this.onEnter.bind(this)} onAfterLeave={this.onAfterLeave.bind(this)}>
