...
storiesOf('Button', module)
  ...
  .add('icon', () => {
    return (
      <div>
        ...
        <Button style={mr10} {...actions} icon="cd-icon-delete" type="primary">Primary</Button>
        <Button style={mr10} {...actions} icon="cd-icon-edit" type="success">Success</Button>
        <Button style={mr10} {...actions} icon="cd-icon-circle-close" type="info">Info</Button>
        <Button style={mr10} {...actions} icon="cd-icon-mic" type="warning">Warning</Button>
        <Button style={mr10} {...actions} icon="cd-icon-back" plain type="danger">Danger</Button>
      </div>
    )
  })
  .add('append icon', () => {
    return (
      <div>
        <Button style={mr10} {...actions} appendIcon="cd-icon-share" type="text">Text</Button>
        ...
        <Button style={mr10} {...actions} appendIcon="cd-icon-edit" type="success">Success</Button>
        <Button style={mr10} {...actions} appendIcon="cd-icon-circle-close"
                type="info">Info</Button>
        <Button style={mr10} {...actions} appendIcon="cd-icon-mic" type="warning">Warning</Button>
  ...
  .add('round', () => {
    return (
      <div>
        ...
        <Button style={mr10} {...actions} icon="cd-icon-mic" type="primary" round>Sound</Button>
  ...
  .add('group', () => {
    return (
      <div>
        <Button.Group>
          <Button {...actions} icon="cd-icon-arrow-left" type="primary">Previous Page</Button>
          <Button {...actions} appendIcon="cd-icon-arrow-right" type="primary">Next Page</Button>
        </Button.Group>
        <br/>
        <br/>
        <Button.Group>
