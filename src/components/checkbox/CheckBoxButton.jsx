...
export default class CheckboxButton extends Checkbox {
  ...
  render(): React.DOM {
    ...
    return (
      <label style={this.style()} className={this.className('cd-checkbox-button', group.props.size ? 'cd-checkbox-button--' + group.props.size : '', {
        'is-disabled': this.props.disabled,
        'is-checked': this.state.checked,
        'is-focus': this.state.focus
      })}>
        <input
          className="cd-checkbox-button__original"
          type="checkbox"
        ...
        />
        <span className="cd-checkbox-button__inner" style={this.state.checked ? {
