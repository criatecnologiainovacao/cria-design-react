    ...
    render(): React.DOM {
        ...
        return (
            ...
            >
                {
                    label && (
                        <label className="cd-form-item__label" style={this.labelStyle()}>
                            {
                                typeof (label) === 'string' ?
                ...
                <div className="cd-form-item__content" style={this.contentStyle()}>
                    {this.props.children}
                    <Transition name="cd-zoom-in-top">
                        {error && <div className="cd-form-item__error">{error}</div>}
                    </Transition>
                </div>
            </div>
        )
