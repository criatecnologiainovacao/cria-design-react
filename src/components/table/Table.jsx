    ...
    return (
      <div
        ...
        className={this.className('cd-table', {
          ...
          'cd-table--enable-row-transition': (tableStoreState.data || []).length && (tableStoreState.data || []).length < 100
        })}
        ref={this.bindRef('el')}
      >
        {props.showHeader && (
        ...
        {!!tableStoreState.fixedColumns.length && (
          ...
          >
            {props.showHeader && (
              <div className="cd-table__fixed-header-wrapper" ref={this.bindRef('fixedHeaderWrapper')}>
                <TableHeader
                  fixed="left"
                  {...this.props}
                  style={{ width: this.bodyWidth || '' }}
            ...
            {props.showSummary && (
              <div className="cd-table__fixed-footer-wrapper" ref={this.bindRef('fixedFooterWrapper')}>
                <TableFooter
                  fixed="left"
                  {...this.props}
                  style={{ width: this.bodyWidth || '' }}
        ...
        {!!tableStoreState.rightFixedColumns.length && (
          ...
          >
            {props.showHeader && (
              <div className="cd-table__fixed-header-wrapper" ref={this.bindRef('rightFixedHeaderWrapper')}>
                <TableHeader
                  fixed="right"
                  {...this.props}
                  style={{ width: this.bodyWidth || '' }}
        ...
        <div className="cd-table__column-resize-proxy" ref={this.bindRef('resizeProxy')} style={{ visibility: 'hidden' }} />
      </div>
    )
  }
}