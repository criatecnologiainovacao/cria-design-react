...
export default class TableBody extends Component<TableBodyProps> {
  ...
  renderCell(row: Object, column: _Column, index: number, rowKey: string | number): React.DOM {
    ...
    if (type === 'expand') {
      return (
        <div
          className={this.classNames('cd-table__expand-icon ', {
            'cd-table__expand-icon--expanded': this.context.tableStore.isRowExpanding(row, rowKey)
          })}
      ...
      if (type === 'uniqueSelection') {
          ...
          return (
              <Radio
                  ...
                  onChange={() => {
                      this.context.tableStore.toggleRowSelection(row)
                  }}
              />
          )
      }
          ...
          {tableStoreState.data.map((row, rowIndex) => {
            ...
            return [(
              <tr
                ...
                className={this.className('cd-table__row', {
                  'cd-table__row--striped': props.stripe && rowIndex % 2 === 1,
              ...
              <tr key={`${rowKey}Expanded`}>
                <td
                  ...
                  className="cd-table__expanded-cell"
                >
